  ...
  try {
    ...
    const template = await prisma.projectTemplate.create({
      data: {
        ...
        projectSize: body.projectSize && body.projectSize !== '' ? parseFloat(body.projectSize.toString()) : null,
        projectSizeUnit: body.projectSizeUnit || null,
        budget: body.budget && body.budget !== '' ? parseFloat(body.budget.toString()) : null,
