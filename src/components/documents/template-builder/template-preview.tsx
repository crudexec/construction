...
const SAMPLE_DATA: Record<string, string> = {
  ...
  '{{lienRelease.id}}': 'cm-release-001',
  '{{lienRelease.type}}': 'CONDITIONAL_PROGRESS',
  '{{lienRelease.typeLabel}}': 'Conditional Progress Release',
  '{{lienRelease.status}}': 'REQUESTED',
  '{{lienRelease.title}}': 'April Progress Release',
  '{{lienRelease.amount}}': '$10,000.00',
  '{{lienRelease.throughDate}}': 'April 20, 2026',
  '{{lienRelease.effectiveDate}}': 'April 25, 2026',
  '{{lienRelease.externalPaymentRef}}': 'PAY-10492',
  '{{lienRelease.externalSource}}': 'Buidflo Payments',
  '{{lienRelease.notes}}': 'Release for work completed through the April draw period.',
  '{{lienRelease.requestedDate}}': 'April 21, 2026',
  '{{lienRelease.approvedDate}}': 'April 24, 2026',
  ...
  '{{project.title}}': 'Lakeside Retail Buildout',
