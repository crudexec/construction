import { PrismaClient, Role, Priority, TaskStatus, CardStatus, EstimateStatus, BidStatus, WalkaroundStatus, DocumentTemplateType } from '@prisma/client'
...
async function main() {
  ...
  await prisma.documentTemplate.create({
    data: {
      ...
      name: 'Default Lien Release',
      description: 'Default template for conditional and unconditional lien release generation',
      type: DocumentTemplateType.LIEN_RELEASE,
      isDefault: true,
      isActive: true,
      content: `
        <div style="font-family: Arial, sans-serif; color: #111827; font-size: 12px; line-height: 1.5;">
          ...
          <div style="border: 1px solid #d1d5db; border-radius: 8px; padding: 16px; margin-bottom: 20px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 4px 0; width: 28%; color: #6b7280;">Release Title</td>
                <td style="padding: 4px 0;">{{lienRelease.title}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">Vendor</td>
                <td style="padding: 4px 0;">{{vendor.companyName}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">Project</td>
                <td style="padding: 4px 0;">{{project.title}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">Contract Number</td>
                <td style="padding: 4px 0;">{{contract.number}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">Amount Covered</td>
                <td style="padding: 4px 0;">{{lienRelease.amount}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">Through Date</td>
                <td style="padding: 4px 0;">{{lienRelease.throughDate}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">Effective Date</td>
                <td style="padding: 4px 0;">{{lienRelease.effectiveDate}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">External Payment Ref</td>
                <td style="padding: 4px 0;">{{lienRelease.externalPaymentRef}}</td>
              </tr>
              <tr>
                <td style="padding: 4px 0; color: #6b7280;">External Source</td>
                <td style="padding: 4px 0;">{{lienRelease.externalSource}}</td>
              </tr>
            </table>
          </div>
